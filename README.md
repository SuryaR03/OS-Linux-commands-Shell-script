...
![alt text](img/egreep1.png)


egrep -w '(H|h)ello' newfile 
## OUTPUT
![alt text](img/egrep2,3.png)
...
![alt text](img/urll1.png)
 
cat urllist.txt | tr -d ' ' | tr -s '.'
## OUTPUT
![alt text](img/urll2.png)
...
![alt text](img/backup2.png)

tar -xvf backup.tar
## OUTPUT
![alt text](img/backup3.png)
